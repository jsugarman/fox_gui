...
FXLabel.new(super_frame,'My Editor Application')
text_editor = FXHorizontalFrame.new(super_frame,LAYOUT_FILL_X|LAYOUT_FILL_Y)
text_field = FXText.new(text_editor,nil,0,TEXT_READONLY|TEXT_WORDWRAP|LAYOUT_FILL_X|LAYOUT_FILL_Y)

text_field.text = "Some sample text"
